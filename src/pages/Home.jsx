    ...
    <main className='home-main'>
      ...
      <section className='concept'>
        ...
        <div className='concept-text'>
          <h2 data-aos="fade-up">品味世界紅茶的最短距離</h2>
          <div className='text-box'>
            <p className='text-1'data-aos="fade-up">2013年創立的 Tea House，相信紅茶是自然風土與人類工藝交織而成的藝術品。我們專注於嚴選來自世界各地知名茶園的紅茶，為台灣茶愛好者帶來更寬廣的風味想像。</p>
            <p className='text-2'data-aos="fade-up">多樣化的紅茶品種，來自大吉嶺高山、阿薩姆平原、錫蘭島嶼到非洲茶園，各自孕育出獨特的氣候風土與香氣層次。每一片茶葉，都是大自然與匠人手藝共同譜寫的詩篇。</p>
            <p className='text-3'data-aos="fade-up">在沖泡與品味的過程中，或許你會對不同的茶香、濃淡與口感產生疑問。Tea House 期盼透過多元的內容，帶領您探索紅茶世界的奧秘──從風味知識、產地故事到沖泡技巧，陪伴您在日常中，找到那一杯專屬於自己的紅茶時光。</p>
          </div>
        </div>
