  ...
  return (
    <>
      <main className='flavor-main'>
        {/* banner */}
        <section className='select-tea'>
          <h2><img src="./images/title-box/Flavor.svg" alt="" /></h2>
          <figure>
